...
public static partial class Tokenizer
{
    ...
    /// An enumerator of sentences. Use foreach (var sentence in sentences).
    /// </returns>
    public static StreamTokenizer<byte> GetSentences(this Stream stream, int maxTokenBytes = 1024)
    {
        var tok = new Tokenizer<byte>([], Sentences.SplitUtf8Bytes);
    ...
    /// An enumerator of sentences. Use foreach (var sentence in sentences).
    /// </returns>
    public static StreamTokenizer<char> GetSentences(this TextReader stream, int maxTokenBytes = 1024)
    {
        var tok = new Tokenizer<char>([], Sentences.SplitChars);
