...
[TestFixture]
public class TestStreamTokenizer2
{
    [SetUp]
    public void Setup()
    {
    ...
    public void Stream()
    {
        ...
        foreach (var input in examples)
        {
            ...
            var streamTokens = Tokenizer2.GetWords(stream);
    ...
    public void StreamReader()
    {
        ...
        foreach (var input in examples)
        {
            ...
            var streamTokens = Tokenizer2.GetWords(reader);
    ...
    public void SetStreamReader()
    {
        ...
        var tokens = Tokenizer2.GetWords(reader);
    ...
    public void StreamEnumerator()
    {
        ...
        using var stream2 = new MemoryStream(bytes);
        var tokens2 = Tokenizer2.GetWords(stream2);
    ...
    public void StreamToList()
    {
        ...
        var list = Tokenizer2.GetWords(stream).ToList();
